...
STATICFILES_DIRS = (
    (SITE_NAME, normpath(join(SITE_ROOT, SITE_NAME, 'static'))),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
        ...
        # local project's context processors
        "{0}.context_processors.site_name".format(SITE_NAME),
)
